...
//        );
        ...
        GeoPoint gPt = new GeoPoint(49.2190, -122.9088); // for New West: 49.2190, -122.9088
    ...
    private void getLocation() {
        ...
        LocationListener locationListener = new LocationListener() {
            public void onLocationChanged(Location location) {
                ...
                GeoPoint gPt = new GeoPoint(latitude - 0.0646, longitude + 0.2066); // for New West: 49.2190, -122.9088
                mMapController.setCenter(gPt);
            }
