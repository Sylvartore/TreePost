...
//        );
        ...
        GeoPoint gPt = new GeoPoint(49.2190, -122.9088); // for New West: 49.2057, -122.9110
    ...
    private void getLocation() {
        ...
        LocationListener locationListener = new LocationListener() {
            public void onLocationChanged(Location location) {
                ...
                GeoPoint gPt = new GeoPoint(latitude - 0.0644, longitude + 0.215); // for New West: 49.2191, -122.9084
                mMapController.setCenter(gPt);
            }
