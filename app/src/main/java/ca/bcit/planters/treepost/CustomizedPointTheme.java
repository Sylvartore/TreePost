 ...
 * {@link CustomizedFastPointOverlay}. Can be used for unlabelled or labelled GeoPoints.
 ...
 * More complex cases should implement {@link CustomizedFastPointOverlay.PointAdapter}, not extend this
 * one. This is a simple example on how to implement an adapter for any case.
 * Created by Miguel Porto on 26-10-2016.
 */

public final class CustomizedPointTheme implements CustomizedFastPointOverlay.PointAdapter {
    private final List<IGeoPoint> mPoints;
    private boolean mLabelled, mStyled;

    public CustomizedPointTheme(List<IGeoPoint> pPoints) {
    ...
    public CustomizedPointTheme(List<IGeoPoint> pPoints, boolean labelled) {
        this(pPoints, labelled, false);
    }

    public CustomizedPointTheme(List<IGeoPoint> pPoints, boolean labelled, boolean styled) {
        mPoints = pPoints;
        mLabelled = labelled;
        mStyled = styled;
    }
