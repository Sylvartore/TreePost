...
public class CustomizedFastPointOverlayOptions {
    ...
    public CustomizedFastPointOverlayOptions() {
    ...
    /**
     * Creates a new {@link CustomizedFastPointOverlayOptions} object with default options.
     * @return {@link CustomizedFastPointOverlayOptions}
     */
    public static CustomizedFastPointOverlayOptions getDefaultStyle() {
        return new CustomizedFastPointOverlayOptions();
    }
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setPointStyle(Paint style) {
        mPointStyle = style;
        return this;
    }
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setSelectedPointStyle(Paint style) {
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setRadius(float radius) {
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setSelectedRadius(float radius) {
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setIsClickable(boolean clickable) {
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setCellSize(int cellSize) {
        mCellSize = cellSize;
        return this;
    }
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setAlgorithm(RenderingAlgorithm algorithm) {
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setSymbol(Shape symbol) {
        mSymbol = symbol;
        return this;
    }
     ...
     * @return The updated {@link CustomizedFastPointOverlayOptions}
     */
    public CustomizedFastPointOverlayOptions setTextStyle(Paint textStyle) {
     ...
     * @return
     */
    public CustomizedFastPointOverlayOptions setMinZoomShowLabels(int minZoomShowLabels) {
     ...
     * @return
     */
    public CustomizedFastPointOverlayOptions setMaxNShownLabels(int maxNShownLabels) {
     ...
     * @return
     */
    public CustomizedFastPointOverlayOptions setLabelPolicy(LabelPolicy labelPolicy) {
